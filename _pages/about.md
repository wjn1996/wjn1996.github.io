...
- I have published some research papers (30+) at ICLR, ACL, AAAI, EMNLP, CIKM, etc., the topic includes Thinking Pattern Research for LLMs, Formal Theorem Proving, Long-horizon with RLVR, Few-shot Leanrning and Prompt Learning. More details can be found in [Publications](https://wjn1996.github.io/publications/) and [Projects](https://wjn1996.github.io/projects/).
...
* [2026-01-27] Our [R-Horizon](https://reasoning-horizon.github.io) has been accepted to ICLR 2026. We release [R-Horizon](https://reasoning-horizon.github.io), which is a novel benchmark and training recipe for RLVR on long-horizon reasoning. 🔥🔥🔥
* [2026-01-23] We release [EvoCUA](https://github.com/meituan/EvoCUA), which focus on GUI agent and achieves SOTA performance (56.7%) through all open-weights models on [OS-World leaderboard](https://os-world.github.io/). 🔥🔥🔥
* [2026-01-15] We release [LongCat-Flash-Thinking-2601](https://github.com/meituan-longcat/LongCat-Flash-Thinking-2601), which aims at advancing our prior LongCat-Flash-Thinking on agentic tool use, searching and heavy thinking. 🔥🔥🔥
...
* [2025-05-16] Our two papers have been accepted to ACL 2025 (Both are Main): [Visual Modality Analysis](https://arxiv.org/pdf/2503.04167), [LogicPro](https://arxiv.org/pdf/2409.12929)
